...
ALL_MODELS = [
    ...
    Model(
        group="local",
        name="local/vicuna-13b",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
        group="local",
        name="local/vicuna-13b-v0",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
        group="local",
        name="local/vicuna-7b",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
        group="local",
    ...
    Model(
        group="local",
        name="local/llama-2-7b-chat",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
        group="local",
        name="local/llama-2-13b-chat",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
        group="local",
        name="local/llama-2-70b-chat",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
    ...
    Model(
        group="local",
        name="local/vicuna-13b-v1.3",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
        group="local",
        name="local/llama-2-70b",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    Model(
        group="together",
        name="together/llama-2-70b-chat",
        tags=[TEXT_MODEL_TAG, FULL_FUNCTIONALITY_TEXT_MODEL_TAG],
    ),
    # Berkeley
    Model(
