...
class ServerService(Service):
    ...
    def make_request(self, auth: Authentication, request: Request, prompt_list: Dict[str, Any]) -> RequestResult:
        ...
        # Use!
        request_result: RequestResult = self.client.make_request(request, prompt_list)
