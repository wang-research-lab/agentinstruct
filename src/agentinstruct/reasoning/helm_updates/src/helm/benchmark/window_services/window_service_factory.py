...
from .llama_2_window_service import Llama2WindowService
...
class WindowServiceFactory:
    ...
    def get_window_service(model_name: str, service: TokenizerService) -> WindowService:
        ...
        elif model_name == "local/vicuna-13b":
            window_service = LlamaWindowService(service)
        elif model_name in ["local/llama-2-7b-chat", "local/llama-2-13b-chat", "local/llama-2-70b-chat"]:
