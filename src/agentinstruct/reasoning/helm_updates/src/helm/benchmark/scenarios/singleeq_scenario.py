...
class SingleEqScenario(Scenario):

    name = "singleeq"
    description = "SingleEq Dataset"
    ...
    def get_instances(self) -> List[Instance]:
        ...
        url: str = (
            "https://raw.githubusercontent.com/chuanyang-Zheng/Progressive-Hint/main/dataset/SingleEq/SingleEq.json"
        )
